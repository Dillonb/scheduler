...
urlpatterns = patterns('',
        ...
        url(r'schedule/lasttime/(?P<scheduleid>\d+)$','scheduler.views.schedule_last_time_view'),
        url(r'^schedule/(?P<otheruserid>\d+)/compare/(?P<viewinguserid>\d+)/(?P<starttime>\d+)?$','scheduler.views.schedule_compare_view'),
        ...
        url(r'^friends/remove/(?P<friendid>\d+)/(?P<confirm>confirm)?$','scheduler.views.friends_remove_view'),
        url(r'^friends/numrequests/$','scheduler.views.num_friend_requests_view'),
        ...
        url(r'^viewevent/(?P<eventid>\d+)$','scheduler.views.event_summary_view'),
        )
